 ...
 _________________________________________________________ -->
			...
			_________________________________________________________ -->
                    ...
                    <div class="col-sm-9" >
                        ...
                        <div class="row products" ng-controller="MyController" ng-init="onInit()">
                            ...
                            <div dir-paginate="model in data | filter: filterText |  itemsPerPage: pageSize" current-page="currentPage">
                              ...
                              <div class="col-md-4 col-sm-6">
                                    <div class="product">
                                        ...
                                        <!-- /.image -->
                                        <div class="text">
                                            <h3><a href="shop-detail.html"> {{ model.brand }} </a></h3>
                                            Product Group ID: <p> {{ model.product_group_id }} </p>
                                            Product Group Main: <p> {{ model.product_group_main }} </p>
                                            Product Group Sub: <p> {{ model.product_group_sub }} </p>
                                            Product POS Group ID: <p> {{ model.product_pos_group_id }} </p>

                                            <label>{{ model.barcode }}</label>
                                            <img src="{{ model.images[0].url_large }}" width="80px">
                                            <p class="price"><!-- <del>$280</del> -->{{ model.rrp }}</p>
                                            <p class="buttons">
